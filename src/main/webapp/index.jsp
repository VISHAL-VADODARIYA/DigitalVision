...
<body id="page-top">
	...
	<nav
		...
		id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top"><strong>Digital</strong>Vision</a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
				alt="..." />
			<!-- Masthead Heading-->
			<h1 class="masthead-heading text-uppercase mb-0">Welcome To Digital Vision</h1> 
			<h4>A Service Based Company</h4>
			<!-- Icon Divider-->
			...
			<!-- Masthead Subheading-->
			<p class="masthead-subheading font-weight-light mb-0">Graphic Design - Photography</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 ms-auto">
					<p class="lead">We believe that marketing is an essential aspect 
					of every business to achieve great success! And that successful 
					marketing objectives are achieved by developing brand experiences,
					awareness and effective visuals. Our team is passionate in creating 
					high quality materials to give business to all our clients. We have 4+ Year
					experienced staff. we provide unique design.</p>
				</div>
				<div class="col-lg-4 me-auto">
					<p class="lead">Photography is an art, the practice of creating durable 
					images by capturing light through a camera. We've come a long way from 
					capturing black and white images to literally taking a picture of a black hole 
					in space. The quality of our pictures have evolved continuously as time progressed. 
					Our desire to capture scenes and moments of our lives have become unparalleled.
					We have Awarded Photographer which is ranker in competition.</p>
				</div>
			</div>
			...
			<div class="text-center mt-4">
				<a class="btn btn-xl btn-outline-light"
					...
					class="fas fa-download me-2"></i> Brochure Download!
				</a>
			</div>
		</div>
	</section>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-4 mb-5 mb-lg-0">
					...
					<p class="lead mb-0">
						Aambedkar Chowk, 150ft ring road <br /> Rajkot - 360005 (Gujarat)
					</p>
				</div>
				<!-- Footer Social Icons-->
				<div class="col-lg-4 mb-5 mb-lg-0">
				...
				<!-- Footer About Text-->
				<div class="col-lg-4">
					<h4 class="text-uppercase mb-4">About Digital Vision</h4>
					<p class="lead mb-0">
						A service based Company which is provide two mainly services, for more information download our brochure or contact us
					</p>
				</div>
			</div>
		</div>
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright &copy; Digital Vision 2022</small>
		</div>
	</div>
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
					...
					<div class="container">
						<div class="row justify-content-center">
							<div class="col-lg-8">
								...
								<p class="mb-4">Portrait photography is about capturing the essence, 
								personality, identity and attitude of a person utilizing backgrounds, lighting and posing.
								While this definition may sound simple, portrait photography can be one of the most challenging 
								forms of photography to master. The goal is to capture a photo that appears both natural and 
								prepared to allow the subject's personality to show through.</p>
